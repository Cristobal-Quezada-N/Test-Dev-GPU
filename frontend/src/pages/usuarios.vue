  ...
  <v-container v-if="accesoPermitido">
    ...
    >
      ...
      <template #item.actions="{ item }">
        ...
        <v-btn color="red" @click="confirmDelete(item)">
          Eliminar
        </v-btn>
      </template>
    </ItemsTable>
    ...
    <v-dialog v-model="showDeleteDialog" max-width="400">
      <v-card>
        ...
        <v-card-actions>
          <v-spacer />
          <v-btn color="grey" variant="tonal" @click="showDeleteDialog = false">
            Cancelar
          </v-btn>
          <v-btn color="red" variant="tonal" @click="deleteUser">
            Eliminar
          </v-btn>
        </v-card-actions>
      </v-card>
    ...
    <v-dialog v-model="showViewDialog" max-width="500">
      <v-card>
        ...
        <v-card-actions>
          <v-spacer />
          <v-btn color="grey" variant="tonal" @click="showViewDialog = false">
            Cerrar
          </v-btn>
          <v-btn color="green" variant="tonal" @click="updateStatus">
            Guardar cambios
          </v-btn>
        </v-card-actions>
      </v-card>
